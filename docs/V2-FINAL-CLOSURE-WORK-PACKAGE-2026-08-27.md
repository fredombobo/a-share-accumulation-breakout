...
| 独立原生 TLS 探针 | PASS | `2026-08-28T01:11:27+08:00` 复测通过；证据 SHA-256 `1741dd66136e...`，无 HTTP 回退。 |
| 权威研究 | 完成但 FAIL | `v2auth20260828e`，代码 `2031bdc70b61`；OOS 组合净收益 8.49%、PF 1.223、回撤 9.18%，但 PBO 31.25%、DSR 46.36%、MinTRL 覆盖 18.8%、嵌套窗 1/5 为正。 |
