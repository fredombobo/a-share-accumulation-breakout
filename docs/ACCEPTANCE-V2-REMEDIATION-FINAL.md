...
不等于“七闸门通过”。当前 R 为策略事实 FAIL，O 因备份 6/7 与当前冻结身份 soak 0/5
未成熟（另保留 2 个旧身份真实日期证据），S 也需
...
| O 运维/恢复 | **FAIL** | 16.5GB 严格恢复完整性/FK/双 SHA 全过，RTO 1789.798/1800 秒；但可验证备份仅 6/7，冻结当前发布身份后 soak 为 0/5；旧身份的 2 个真实交易日证据保留但不冒充当前身份。 |
